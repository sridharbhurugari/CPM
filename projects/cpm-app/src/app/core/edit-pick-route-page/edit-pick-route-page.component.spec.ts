...
import { GridModule, ButtonActionModule, FooterModule, LayoutModule, PopupWindowService, PopupDialogService, IPopupWindowContainer, PopupWindowProperties } from '@omnicell/webcorecomponents';
...
describe('EditPickRoutePageComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    pickRoutesService = { get: () => of(pickRoute), saveAs: saveAsSpy };
