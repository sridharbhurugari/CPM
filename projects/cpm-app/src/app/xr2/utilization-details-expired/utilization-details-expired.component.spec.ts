...
describe('DetailsExpiredComponent', () => {
  ...
  devicesService = {
    ...
    TestBed.configureTestingModule({
      declarations: [ DetailsExpiredComponent, MockSearchPipe, MockDestockHeaderComponent, MockTranslatePipe ],
    ...
    beforeEach(() => {
    fixture = TestBed.createComponent(DetailsExpiredComponent);
