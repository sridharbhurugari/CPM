...
export class Xr2ExceptionsPageComponent implements OnInit, AfterViewInit {
  ...
  navigatedetailspage(exceptions: IXr2ExceptionsItem) {
    this.wpfActionControllerService.ExecuteContinueNavigationAction(`xr2/stocking/exceptiondetails`, { TrayID: exceptions.TrayID.toString(), DeviceID: exceptions.DeviceID, CompletedDateTime: exceptions.CompletedDateTime, DeviceName: exceptions.DeviceName, TrayDescription: exceptions.TrayDescription , TrayType: exceptions.IsReturn});
  }
