...
describe('UtilizationHeaderComponent', () => {
  ...
  let workstation: IWorkstationNameData = {WorkstationShortName: "WK1", WorkstationFriendlyName: ""};
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: WorkstationTrackerService, useValue: { GetWorkstationName: () => of(workstation) } },
      ]
    })
    .compileComponents();
  }));
  ...
  describe('Device Default Selection', () => {
    it('Two Assigned Workstations will default to the first one', fakeAsync(() => {
      selectableDeviceInfo1.DefaultOwnerName = "WK1";
      workstation = {WorkstationShortName: "WK1", WorkstationFriendlyName: ""};
      selectableDeviceInfoList = [selectableDeviceInfo1, selectableDeviceInfo2];
    ...
    it('No assigned XR2s will not default when multiple XR2s exist', fakeAsync(() => {
      selectableDeviceInfo1.DefaultOwnerName = "WK1";
      workstation = {WorkstationShortName: "WK2", WorkstationFriendlyName: ""};
      selectableDeviceInfoList = [selectableDeviceInfo1, selectableDeviceInfo2];
